...
import {Navbar, Nav, Alert, Card, ListGroup, ListGroupItem} from 'react-bootstrap'
              ...
              : this.state.events
                .map((val, idx) =>
                  (<Card> <Card.Body>
                    ...
                    <Card.Subtitle className="mb-2 text-muted">from {val.time.start_time} to {val.time.end_time}</Card.Subtitle>
